...
@section('main-content')
    ...
    <section class="shop checkout section">
        <div class="container">
                <form class="form" method="POST"  onsubmit="return validateForm()" action="{{route('cart.order')}}" id="payment-form">
                    @csrf
                    <div class="row"> 
                                    ...
                                    <div class="content">
                                        <div class="checkbox">
                                            ...
                                            <form-group>
                                                ...
                                                <input name="payment_method" id="visa" type="radio" value="paypal"> <label> Visa/Master</label> 
                                            </form-group>
